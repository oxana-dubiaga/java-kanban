...
public class SubtaskTest {
    ...
    public void equalsSubtasksByIdCheck() {
        Subtask subtask1 = new Subtask("name", "discription", 4, 3);
        Subtask subtask2 = new Subtask("name", "discription", 4, 3);
    ...
    public void changeEpicId() {
        int epicId = 2;
        Subtask subtask = new Subtask("name", "discription", 1, 2);
        int newEpicId = 3;
    ...
    public void cantUseSubtaskAsItsOwnEpic() {
        Subtask subtask = new Subtask("name", "discription", 5, 3);
